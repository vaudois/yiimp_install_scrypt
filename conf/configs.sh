...
function addmoreserverconfig5
{
	...
	echo -e "define('YAAMP_URGEN_NOTE', 'HOME','#33FF4C', null, 'This urgent note is configured in: var/web/serverconfig.php');" | sudo tee -a /var/web/serverconfig.php >/dev/null 2>&1
}
