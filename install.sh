...
clear
	...
	if [[ ("$DISTRO" == "20") ]]; then
		...
		sudo zcat 2023-05-27-yiimp.sql.gz | sudo mysql -u root -p=${rootpasswd} yiimpfrontend
		...
		sudo zcat 2023-05-27-yiimp.sql.gz | sudo mysql --defaults-group-suffix=host1
